...
public class CumulativeInMemoryStateWithNavigableMap {
	...
	public CumulativeInMemoryStateWithNavigableMap(HRegionInfo regionInfo) {
		super();
	...
	public static class InMemoryStoreScanner extends KeyValueListScanner
		...
		InMemoryStoreScanner(final Scan scan, CumulativeInMemoryStateWithNavigableMap inMemState) {
