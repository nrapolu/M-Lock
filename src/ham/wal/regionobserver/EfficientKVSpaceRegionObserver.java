...
/**
 * A sample region observer that tests the RegionObserver interface. It works
 * with TestRegionObserverInterface to provide the test case.
 */
public class EfficientKVSpaceRegionObserver extends BaseRegionObserver {
